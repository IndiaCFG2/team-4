...
.k-button.k-bare, .k-calendar-header .k-button, .k-toolbar .k-split-button.k-state-disabled .k-button, .k-spreadsheet-quick-access-toolbar .k-button, .k-spreadsheet-sheets-bar .k-button, .k-spreadsheet-popup .k-button, kendo-scheduler .k-scheduler-toolbar li a,
...
.k-button.k-bare:hover, .k-calendar-header .k-button:hover, .k-toolbar .k-split-button.k-state-disabled .k-button:hover, .k-spreadsheet-quick-access-toolbar .k-button:hover, .k-spreadsheet-sheets-bar .k-button:hover, .k-spreadsheet-popup .k-button:hover, kendo-scheduler .k-scheduler-toolbar li a:hover,
...
.k-state-hover.k-button.k-bare, .k-calendar-header .k-state-hover.k-button, .k-toolbar .k-split-button.k-state-disabled .k-state-hover.k-button, .k-spreadsheet-quick-access-toolbar .k-state-hover.k-button, .k-spreadsheet-sheets-bar .k-state-hover.k-button, .k-spreadsheet-popup .k-state-hover.k-button, kendo-scheduler .k-scheduler-toolbar li a.k-state-hover,
...
.k-button.k-bare:active, .k-calendar-header .k-button:active, .k-toolbar .k-split-button.k-state-disabled .k-button:active, .k-spreadsheet-quick-access-toolbar .k-button:active, .k-spreadsheet-sheets-bar .k-button:active, .k-spreadsheet-popup .k-button:active, kendo-scheduler .k-scheduler-toolbar li a:active,
...
.k-state-active.k-button.k-bare, .k-calendar-header .k-state-active.k-button, .k-toolbar .k-split-button.k-state-disabled .k-state-active.k-button, .k-spreadsheet-quick-access-toolbar .k-state-active.k-button, .k-spreadsheet-sheets-bar .k-state-active.k-button, .k-spreadsheet-popup .k-state-active.k-button, kendo-scheduler .k-scheduler-toolbar li a.k-state-active,
...
.k-button.k-bare:hover:active, .k-calendar-header .k-button:hover:active, .k-toolbar .k-split-button.k-state-disabled .k-button:hover:active, .k-spreadsheet-quick-access-toolbar .k-button:hover:active, .k-spreadsheet-sheets-bar .k-button:hover:active, .k-spreadsheet-popup .k-button:hover:active, kendo-scheduler .k-scheduler-toolbar li a:hover:active,
...
.k-button.k-bare:hover.k-state-active, .k-calendar-header .k-button:hover.k-state-active, .k-toolbar .k-split-button.k-state-disabled .k-button:hover.k-state-active, .k-spreadsheet-quick-access-toolbar .k-button:hover.k-state-active, .k-spreadsheet-sheets-bar .k-button:hover.k-state-active, .k-spreadsheet-popup .k-button:hover.k-state-active, kendo-scheduler .k-scheduler-toolbar li a:hover.k-state-active,
...
.k-button.k-bare::before, .k-calendar-header .k-button::before, .k-toolbar .k-split-button.k-state-disabled .k-button::before, .k-spreadsheet-quick-access-toolbar .k-button::before, .k-spreadsheet-sheets-bar .k-button::before, .k-spreadsheet-popup .k-button::before, kendo-scheduler .k-scheduler-toolbar li a::before,
...
.k-toolbar .k-dropdown-wrap::before, kendo-scheduler .k-scheduler-toolbar li a::before,
kendo-scheduler .k-scheduler-toolbar li .k-link::before,
kendo-scheduler .k-scheduler-footer li a::before,
kendo-scheduler .k-scheduler-footer li .k-link::before {
...
.k-primary.k-button.k-bare, .k-calendar-header .k-primary.k-button, .k-toolbar .k-split-button.k-state-disabled .k-primary.k-button, .k-spreadsheet-quick-access-toolbar .k-primary.k-button, .k-spreadsheet-sheets-bar .k-primary.k-button, .k-spreadsheet-popup .k-primary.k-button, kendo-scheduler .k-scheduler-toolbar li a.k-primary,
kendo-scheduler .k-scheduler-toolbar li .k-primary.k-link,
kendo-scheduler .k-scheduler-footer li a.k-primary,
kendo-scheduler .k-scheduler-footer li .k-primary.k-link, .k-button-flat.k-primary:hover, .k-edit-buttons .k-primary.k-button:hover, .k-primary.k-button.k-flat:hover,
.k-primary.k-button.k-bare:hover, .k-calendar-header .k-primary.k-button:hover, .k-toolbar .k-split-button.k-state-disabled .k-primary.k-button:hover, .k-spreadsheet-quick-access-toolbar .k-primary.k-button:hover, .k-spreadsheet-sheets-bar .k-primary.k-button:hover, .k-spreadsheet-popup .k-primary.k-button:hover, kendo-scheduler .k-scheduler-toolbar li a.k-primary:hover,
kendo-scheduler .k-scheduler-toolbar li .k-primary.k-link:hover,
kendo-scheduler .k-scheduler-footer li a.k-primary:hover,
kendo-scheduler .k-scheduler-footer li .k-primary.k-link:hover, .k-button-flat.k-primary.k-state-hover, .k-edit-buttons .k-primary.k-state-hover.k-button, .k-primary.k-state-hover.k-button.k-flat,
.k-primary.k-state-hover.k-button.k-bare, .k-calendar-header .k-primary.k-state-hover.k-button, .k-toolbar .k-split-button.k-state-disabled .k-primary.k-state-hover.k-button, .k-spreadsheet-quick-access-toolbar .k-primary.k-state-hover.k-button, .k-spreadsheet-sheets-bar .k-primary.k-state-hover.k-button, .k-spreadsheet-popup .k-primary.k-state-hover.k-button, kendo-scheduler .k-scheduler-toolbar li a.k-primary.k-state-hover,
...
kendo-scheduler .k-scheduler-footer li .k-primary.k-state-hover.k-link,
...
.k-primary.k-state-disabled.k-button.k-bare, .k-calendar-header .k-primary.k-state-disabled.k-button, .k-toolbar .k-split-button.k-state-disabled .k-primary.k-state-disabled.k-button, .k-spreadsheet-quick-access-toolbar .k-primary.k-state-disabled.k-button, .k-spreadsheet-sheets-bar .k-primary.k-state-disabled.k-button, .k-spreadsheet-popup .k-primary.k-state-disabled.k-button, kendo-scheduler .k-scheduler-toolbar li a.k-primary.k-state-disabled,
